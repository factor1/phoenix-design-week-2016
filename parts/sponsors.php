  ...
  <div class="container">
    ...
    <?php //if(have_rows('premier_sponsors', 'option')):?>
      <div class="row row--justify-content-center">
        <?php //while(have_rows('premier_sponsors', 'option')): the_row();?>
          <div class="col-3 text-center sponsors--grid-item">
            <a href="http://gcu.edu<?php //the_sub_field('sponsor_link');?>" target="_blank">
              <img src="<?php //the_sub_field('sponsor_image');?>  <?php bloginfo('template_url');?>/assets/img/gcu.jpg" alt="Sponsor Image">
            </a>
          </div>
        <?php //endwhile;?>
      </div>
